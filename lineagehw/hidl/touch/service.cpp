...
#define LOG_TAG "vendor.lineage.touch@1.0-service.kirin659"
...
using ::vendor::lineage::touch::V1_0::kirin659::GloveMode;
using ::vendor::lineage::touch::V1_0::IKeyDisabler;
using ::vendor::lineage::touch::V1_0::kirin659::KeyDisabler;
